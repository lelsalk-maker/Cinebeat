...
function planOnce(opts) {
  ...
  if (chrono) {
    ...
    let res = layoutChrono(segs, queue, 0);
    ...
    for (let k = 0; k < 2 && allOn && res.dropped.length; k++) {
      const r2 = layoutChrono(segs, queue, res.dropped.length * (k + 1));
   ...
   */
  function layoutChrono(segs0, queue, bias) {
